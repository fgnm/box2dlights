...
public class Box2dLightPseudo3dTest extends InputAdapter implements ApplicationListener {
	...
	ArrayList<P3dLight> lights = new ArrayList<>(BALLSNUM);
	...
	public void create() {
		...
		rayHandler = new P3dRayHandler(world);
	...
	public void render() {
		...
		if (lightsType == 3) {
			...
			lights.get(0).setHeight(sunDirection);
		}
	...
	void initPointLights() {
		clearLights();
		for (int i = 0; i < BALLSNUM; i++) {
			P3dPointLight light = new P3dPointLight(
	...
	void initDirectionalLight() {
		...
		P3dDirectionalLight light = new P3dDirectionalLight(
	...
	private void createBoxes() {
		...
		for (int i = 0; i < BALLSNUM; i++) {
			...
			boxBody.createFixture(def).setUserData(new P3dData(1));
			balls.add(boxBody);
		}
