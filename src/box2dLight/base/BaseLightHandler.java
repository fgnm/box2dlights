...
public abstract class BaseLightHandler implements Disposable {
	...
	protected ShaderProgram customLightShader = null;
	 ...
	 *
	 * @see #BaseLightHandler(World, int, int)
	 */
	 ...
	 */
	public BaseLightHandler(World world, int fboWidth, int fboHeight) {
		this.world = world;
	 ...
	 */
	public abstract void resizeFBO(int fboWidth, int fboHeight);
	 ...
	 * Override this if you are using custom light shader
	 */
	protected void updateLightShaderPerLight (BaseLight light) {
