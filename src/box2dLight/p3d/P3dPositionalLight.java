...
public abstract class P3dPositionalLight extends P3dLight {
	 ...
	 */
	public P3dPositionalLight(P3dRayHandler lightManager, int rays, Color color, float distance, float x, float y, float directionDegree) {
	...
	public void render() {
		...
		lightMesh.render(
				lightHandler.lightShader, GL20.GL_TRIANGLE_FAN, 0, vertexNum);
	}
	...
	protected void setMesh() {
		// ray starting point
		int size = 0;
		float colorF = color.cpy().mul(1f / P3dRayHandler.colorReduction).toFloatBits();
